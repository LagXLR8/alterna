...
import com.example.vinemod.Constants;
...
public class ModConfig {
   ...
   public static void setServerConfig(ModConfig serverConfig) {
      ...
      Constants.LOG.info("Applied server configuration for VineMod.");
   }
   ...
   public static void restoreLocalConfig() {
      if (BACKUP != null) {
         INSTANCE = BACKUP;
         BACKUP = null;
         Constants.LOG.info("Restored local configuration for VineMod.");
      }
